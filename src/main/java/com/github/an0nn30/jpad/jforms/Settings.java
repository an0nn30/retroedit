...
public class Settings extends JDialog {
    ...
    public Settings(EditorFrame editorFrame) {
        ...
        if (com.github.an0nn30.jpad.settings.Settings.getInstance().getInterfaceTheme().equals("retro")) {
            setUndecorated(true);
        ...
        colorThemeComboBox.setSelectedItem(com.github.an0nn30.jpad.settings.Settings.getInstance().getInterfaceTheme());
...
//            EventBus.publish(EventType.THEME_CHANGED.name(), colorThemeComboBox.getSelectedItem(), this);
        ...
        fontSizeSpinner.setValue(com.github.an0nn30.jpad.settings.Settings.getInstance().getEditorFontSize());

        String[] fontFamilies = GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames();
        for (String fontFamily : fontFamilies) {
            fontFamilySpinner.addItem(fontFamily);
        }
        fontFamilySpinner.setSelectedItem(com.github.an0nn30.jpad.settings.Settings.getInstance().getEditorFontFamily());
    ...
    private void onOK() {
        // add your code here
        var settings = com.github.an0nn30.jpad.settings.Settings.getInstance();
