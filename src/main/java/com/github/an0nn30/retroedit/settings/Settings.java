package com.github.an0nn30.retroedit.settings;
...
public class Settings {
    ...
    private boolean enableClassicTheme = false;
    ...
    public boolean isEnableClassicTheme() {
        return enableClassicTheme;
    }

    public void setEnableClassicTheme(boolean enableClassicTheme) {
        this.enableClassicTheme = enableClassicTheme;
        EventBus.publish(EventType.THEME_CHANGED.name(), "retro", null);
        saveSettings();
    }
